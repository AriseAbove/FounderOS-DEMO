/**
 * The OS mark — the ring-and-S logo from the OS brand assets
 ...
 * letter S — design call (2026-07-13): the S runs vertical like the O,
...
export function OsMark({ size = 34, color = '#ef4444', className }: { size?: number; color?: string; className?: string }) {
  return (
    <svg viewBox="0 0 100 100" width={size} height={size} className={className} role="img" aria-label="Arise OS">
