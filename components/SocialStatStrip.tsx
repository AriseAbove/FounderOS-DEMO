          ...
          {data === null ? (
            ...
            <>
              ...
              <p className="mt-4 font-mono text-[10px] text-os-dim">
                {RANGE_LABEL[String(range)]} window · {metric === 'dms' ? 'DM totals are seeded dummy until a source is wired' : 'email tracks the real subscriber count once a source records it'}
              </p>
            </>
          )}
        </div>
