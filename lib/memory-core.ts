 ...
 * the operator rendered as the constellation of his actual brain-store notes.
 *
...
// Open-graph density. Deliberately LOW: smoothness beats richness (design:
...
export function distillMemoryGraph(
  ...
  // centerFolder quota: the spotlighted folder (design: "populate Claude
...
// at (R_CORE + 10) / R_CORE ≈ 1.19 units) — design: notes very close to the
